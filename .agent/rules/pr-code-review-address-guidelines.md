...
Here is a real-world example of a "Purrfect" PR comment that addresses multiple rounds of feedback with high fidelity and clarity. Strive for this level of detail.
...
| Reviewer                       | Comments | Status   | Latest |
| ------------------------------ | -------- | -------- | ------ |
| **`@gemini-code-assist`**      | 5        | ✅ Fixed | Today  |
| **`@chatgpt-codex-connector`** | 3        | ✅ Fixed | Today  |
| **`@Copilot`**                 | 12       | ✅ Fixed | Today  |

<details>
<summary>[Found and addressed a total of 20 code review feedback from 3 code reviews left by 3 reviewers. This Took ~30 minutes for Antigravity. Click to expand]</summary>

- **Reviewers**: 3 (`@gemini-code-assist`, `@chatgpt-codex-connector`, `@Copilot`)
- **Coverage**: 100% Addressed
</details>
